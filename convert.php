...
$output_xml = str_replace("%%SHIPPING_METHOD_ID%%", "", $output_xml); //mitä arvoja?
$output_xml = str_replace("%%SHIPPING_METHOD%%", "", $output_xml);

$output_xml = str_replace("%%PAYMENT_METHOD_ID%%", "", $output_xml); //mitä arvoja?
$output_xml = str_replace("%%PAYMENT_METHOD%%", "", $output_xml);
